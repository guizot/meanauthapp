...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        if (!this.validateService.validateRegister(newUser)) {
            this.flashMessages.show('Please filled all fields', {
        ...
        this.authService.registerUser(newUser)
            ...
            if (data.success) {
                _this.flashMessages.show('You are now registered and can log in', {
                    cssClass: 'alert-success',
                    timeout: 3000
                });
                _this.router.navigate(['/login']);
...
module.exports = __webpack_require__(/*! C:\Users\User\Documents\Mean Stack\meanauthapp\client\src\main.ts */"./src/main.ts");
